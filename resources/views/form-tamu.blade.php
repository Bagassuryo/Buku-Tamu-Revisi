...
<head>
    ...
    <style>
        /* Animasi toast — tidak bisa murni Tailwind */
        .toast-enter {
        ...
        /* Highlight teks pencarian di dropdown */
        .dd-item mark {
            background: #dbeafe;
            color: #1d4ed8;
            border-radius: 2px;
...
<body class="bg-slate-100 min-h-screen font-sans">
    ...
    <div class="bg-linear-to-br from-[#1a2a6c] to-[#1B75BC] pt-10 pb-20 text-center relative overflow-hidden">
        ...
        <h1 class="font-serif text-[32px] text-white mb-2 leading-tight">
            Buku Tamu
        </h1>
        <p class="text-white/70 text-sm">
            Silakan lengkapi data kunjungan Anda dengan benar dan jelas
        </p>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-5 -mt-10 pb-12 relative z-10">
        <div class="bg-white rounded-2xl shadow-2xl overflow-visible">
            ...
            <div class="p-7">
                ...
                {{-- Form --}}
                <form action="{{ route('tamu.store') }}" method="POST" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <p class="text-[11.5px] text-slate-400 mt-1.5">
                            Cari berdasarkan nama OPD, bidang, atau jenis layanan
                        </p>
                        @error('layanan')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
    ...
    <script>
        ...
        // ── Toast untuk error validasi Laravel ───────────────────────────────
        @if ($errors->any())
            document.addEventListener('DOMContentLoaded', function() {
